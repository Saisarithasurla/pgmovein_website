...
export default function AreaCard({ area }: { area: Area }) {
  return (
    <article className="group rounded-lg border border-slate-200 bg-white p-4 transition-all duration-200 hover:-translate-y-0.5 hover:border-navy/30 hover:shadow-[0_8px_24px_rgba(16,42,67,0.08)] sm:p-5">
      <div className="flex items-start justify-between gap-3 sm:gap-4">
        ...
        <span className="shrink-0 rounded-full bg-slate-50 px-3 py-1 text-xs font-bold text-navy">
      ...
      <div className="mt-5 border-t border-slate-100 pt-4">
        <div className="grid gap-2 text-xs font-semibold text-slate-600 min-[380px]:grid-cols-3 sm:gap-3">
          ...
          <span className="flex items-center gap-1.5">
            <Hotel className="h-3.5 w-3.5 text-navy" />
