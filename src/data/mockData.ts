...
export const BANGALORE_AREAS = [
  ...
  "Banaswadi",
  "Banaswadi Main Road",
  "Bannerghatta Road (Gottigere/Hulimavu)",
  "Basavanagudi",
  "Basaveshwaranagar",
  "Begur Road",
  "Bellandur",
  "Bhartiya City Area",
  "Bidadi (Industrial township)",
  "Bilekahalli",
  "Bommanahalli",
  ...
  "Cooke Town",
  "Cox Town",
  "Dasarahalli (Hebbal/North)",
  "Dasarahalli (T. Dasarahalli)",
  "Deepanjali Nagar",
  "Devanahalli (Near Airport Hub)",
  "Devarachikkanahalli",
  "Doddaballapur Road (Peripheral cluster)",
  "Doddanekundi",
  "Doddathogur",
  "Domlur",
  "Electronic City",
  ...
  "Kaggadasapura",
  "Kalyan Nagar",
  "Kalyan Nagar (Outer Ring Road stretch)",
  "Kamalanagar",
  "Kammanahalli",
  "Kammanahalli Main Road",
  "Kamshipalya",
  "Kanakapura Road (Anjanapura/Doddakallasandra)",
  "Kasavanahalli",
  "Kasturi Nagar",
  "Kenchanahalli",
  "Kengeri Gollahalli",
  ...
  "Malleshwaram",
  "Malleswaram West",
  "Manyata Tech Park Area (Nagawara)",
  "Marathahalli",
  "Mathikere",
  "Munnekolala",
  "Murugeshpalya",
  "Nagarbhavi",
  "Nagasandra",
  "Nagawara Village Area",
  "Nandini Layout",
  "Nayandahalli",
  "Nelamangala (Suburban hub)",
  "Padmanabhanagar",
  "Pai Layout",
  "Panathur",
  "Pantarpalya",
  ...
  "Rajarajeshwari Nagar Temple Area",
  "Ramamurthy Nagar",
  "Rayasandra",
  "Richards Town",
  "Sadashivanagar",
  ...
  "Sanjeevini Nagar",
  "Sarjapur Road",
  "Sarjapur Road (Kaikondrahalli / Doddakannelli)",
  "Singasandra",
  "Srinagar",
  "Subramanyapura",
  "Sunkadakatte",
  ...
  "Tin Factory Area (Benniganahalli)",
  "Tyagarajanagar",
  "Ulsoor (Halasuru)",
  "Uttarahalli",
