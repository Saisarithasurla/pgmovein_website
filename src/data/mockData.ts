...
export const BANGALORE_AREA_GROUPS: AreaGroup[] = [
  {
    name: "Bellandur",
    subAreas: [
      "Bellandur Central", "Bellandur Lake Area", "Yemalur", "Devarabeesanahalli",
      "Kariyammana Agrahara", "Bellandur Gate", "Kaikondrahalli", "Kadubeesanahalli",
      "Doddakannelli", "Munnekollal",
    ],
  },
  {
    name: "BTM Layout",
    subAreas: [
      "BTM 1st Stage", "BTM 2nd Stage", "BTM Layout 16th Main Area", "Madiwala",
      "Tavarekere", "JP Nagar 1st Phase", "Dollars Colony", "NS Palya",
      "Maruthi Nagar", "Bannerghatta Road Junction",
    ],
  },
  {
    name: "Electronic City",
    subAreas: [
      "Phase 1", "Neeladri Nagar", "Doddathogur", "Konappana Agrahara", "Veerasandra",
      "Shikaripalya", "Gollahalli", "Hebbagodi", "Huskur",
      "Phase 2", "Ananth Nagar", "Bettadasanapura", "Basapura", "Singasandra",
      "Chikkanagamangala", "Kammasandra", "Bommasandra", "Jigani Road Junction",
    ],
  },
  {
    name: "HSR Layout",
    subAreas: [
      ...
      "Agara", "Haralur", "Kudlu", "Mangammanapalya", "Somasundarapalya",
    ],
  },
  {
    name: "Koramangala",
    subAreas: [
      ...
      "6th Block", "7th Block", "8th Block", "ST Bed Layout", "Ejipura", "Sony World Junction",
    ],
  },
  {
    name: "Mahadevapura",
    subAreas: [
      "Mahadevapura Main", "Garudachar Palya", "Hoodi", "KR Puram", "Doddanekkundi",
      "B Narayanapura", "CV Raman Nagar", "A Narayanapura", "Singayyanapalya", "Basavanapura",
    ],
  },
  {
    name: "Marathahalli",
    subAreas: [
      "Marathahalli Bridge", "Munnekollal", "Spice Garden", "Aswath Nagar",
      "Tulasi Theatre Road", "Kundalahalli", "AECS Layout", "Varthur Road Junction",
      "HAL Old Airport Road", "Panathur",
    ],
  },
  {
    name: "Nagawara",
    subAreas: [
      "Manyata Residency", "Thanisandra Main Road", "Rachenahalli", "Amrutahalli",
      "HBR Layout", "Kalyan Nagar", "Hebbal", "Kannur", "RK Hegde Nagar", "Jakkur",
    ],
  },
  {
    name: "Sarjapur Road",
    subAreas: [
      "Panathur", "Kadubeesanahalli", "Kaikondrahalli", "Doddakannelli", "Carmelaram",
      "Chikkakannalli", "Kasavanahalli", "Hadosiddapura", "Kodathi", "Dommasandra",
      "Gunjur", "Mullur", "Chambenahalli", "Haralur", "Harlur Road", "Sompura",
    ],
  },
  {
    name: "Whitefield",
    subAreas: [
      "Whitefield Main", "Hope Farm Junction", "ITPL", "Pattandur Agrahara", "EPIP Zone",
      "Varthur", "Hoodi", "Kadugodi", "Belathur", "Channasandra", "Seegehalli",
      "Thubarahalli", "Nallurahalli", "Immadihalli", "Vinayaka Layout", "Brookefield", "Siddapura",
    ],
  },
];
