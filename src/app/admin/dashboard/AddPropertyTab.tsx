...
export function AddPropertyTab() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const payload = {
      ...
      owner_number: formData.owner_number.trim(),
  ...
  const handleEdit = (prop: SupabaseProperty) => {
    ...
    setFormData({
       ...
       owner_number: prop.owner_number || "",
                ...
                {expandedSection === "basic" && (
                  <div className="pb-6 space-y-4 animate-fade-in">
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                      ...
                      <div>
                        <label className="block text-xs font-bold text-gray-600 mb-1.5">Owner / Manager Number *</label>
                        <input
                          type="text"
                          required
